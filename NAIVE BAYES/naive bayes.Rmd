...
```
The model has about 92% accuracy when determining whether or not a song is by Drake in the testing set. We will now try adjusting the Lapalce to see if we can increase the accuracy even more.
```{r}
